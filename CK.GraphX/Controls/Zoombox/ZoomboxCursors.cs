  ...
  public class ZoomboxCursors
  {
    ...
    static ZoomboxCursors()
    {
      try
      {
        ...
        //_zoom = new Cursor( ResourceHelper.LoadResourceStream( Assembly.GetExecutingAssembly(), "Controls/Zoombox/Resources/Zoom.cur" ) );
       // _zoomRelative = new Cursor(ResourceHelper.LoadResourceStream(Assembly.GetExecutingAssembly(), "Controls/Zoombox/Resources/ZoomRelative.cur"));
      }
